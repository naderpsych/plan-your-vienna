  ...
  },
  {
    ...
    stops: [
      ...
      },
      {
        ...
        about: "Neuer Markt 16. The café and pastry shop the Viennese actually buy from, rather than the one on the postcards.",
        plan: "Coffee and cake: Kardinalschnitte, Topfenstrudel or Malakofftorte.",
        lat: 48.2049,
        lng: 16.3703,
      ...
      },
      {
        ...
        time: "16:30–18:30",
        title: HOTEL.name,
        plan: "Back to the hotel and rest. Short shopping nearby only if you feel like it.",
        fixed: true,
        lat: HOTEL.lat,
        lng: HOTEL.lng,
      },
